...
const TableDataRow = ({ bidRequest, handelAcceptBtn, handelRejectBtn }) => {
  const { job_title, email, deadline, price, category, _id, status } =
    bidRequest;
  return (
    <tr>
